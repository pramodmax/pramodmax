...
<img src="https://capsule-render.vercel.app/api?type=waving&color=EE0000&height=200&section=header&text=Pramod%20Padmanabhan&fontSize=50&fontColor=ffffff&animation=fadeIn&fontAlignY=38&desc=Principal%20Architect%20%7C%20AI%2FML%20%7C%20Cloud-Native%20%7C%20Integration&descAlignY=55&descAlign=50" width="100%"/>

[![LinkedIn](https://img.shields.io/badge/LinkedIn-Pramod%20Padmanabhan-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/pramodmax/)
[![GitHub](https://img.shields.io/badge/GitHub-pramodmax-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/pramodmax)
...
Principal Architect at **Red Hat** with **17+ years** of experience architecting enterprise-grade solutions across AI/ML, cloud-native platforms, event streaming, and middleware integration. Currently pursuing a **Post Graduate Program in AI & Machine Learning at Caltech**.

I specialize in bridging the gap between cutting-edge AI platforms and enterprise-scale cloud-native infrastructure — helping organizations modernize their architecture on OpenShift and adopt intelligent automation.
...
```text
🤖  AI/ML Platform Engineering   ████████████░░   OpenShift AI, LLM Ops, Model Serving
☁️  Cloud-Native Architecture    ████████████░░   Kubernetes, OpenShift, GitOps
⚡  Event Streaming              ██████████░░░░   Kafka, AMQ Streams, Apache Camel
🔧  Intelligent Automation       ████████░░░░░░   Ansible Automation Platform, Python
```
...
|-------|--------------|--------|------|
| 🏅 | Red Hat Certified Specialist in **OpenShift Administration** | Red Hat | 2019 |
| 🏅 | Red Hat Certified Specialist in **Ansible Automation** | Red Hat | 2019 |
| 🏅 | Red Hat Certified Specialist in **Messaging Administration** | Red Hat | 2019 |
| 🏅 | Red Hat Certified System Administrator in **JBoss EAP 7.x** | Red Hat | 2019 |
...
- **AI/ML Platform Operations** — Model serving, MLOps pipelines, OpenShift AI, LLM deployment on Kubernetes
- **Cloud-Native Architecture** — Kubernetes, OpenShift (3.x → 4.x), multi-cluster, GitOps at scale
- **Event Streaming** — Kafka / AMQ Streams, event-driven architecture, high-throughput messaging
- **Enterprise Integration** — Apache Camel, SOA, REST/SOAP, IBM MQ, TIBCO
- **Automation** — Ansible Automation Platform, CI/CD pipeline design, infrastructure as code
- **Pre-Sales & Architecture** — Solution design, RFP responses, stakeholder engagement

---

<div align="center">

<img src="https://capsule-render.vercel.app/api?type=waving&color=EE0000&height=100&section=footer" width="100%"/>

*"Architecture is not just about technology — it's about enabling business outcomes at scale."*

![Profile Views](https://komarev.com/ghpvc/?username=pramodmax&color=EE0000&style=for-the-badge&label=Profile+Views)
